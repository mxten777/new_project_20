      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-gray-700 mb-8 font-medium">나에게 꼭 맞는 정부·지자체 복지 혜택을 쉽고 빠르게 찾으세요.<br />
          연령, 가구 유형, 소득, 지역만 입력하면 <span className="text-blue-500 font-bold">맞춤형 복지 서비스</span>를 추천해드립니다.</p>
            <Link to="/profile" className="inline-block bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-4 px-10 rounded-2xl shadow-xl hover:from-blue-600 hover:to-purple-600 transition text-xl animate-bounce-slow">내게 맞는 복지 찾기</Link>
      </div>
    </section>
  );
}
